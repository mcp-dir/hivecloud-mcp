...
HiveCloud CT-e / MDF-e segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **HiveCloud (Bsoft / nstech)** | BR | fiscal-document issuer API (data provider) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [hivecloud@mcp.ai](mailto:hivecloud@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
